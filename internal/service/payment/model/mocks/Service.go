...
func (_m *Service) Add(ctx context.Context, _a1 log.Logger, records []*model.Payment) error {
...
func (_m *Service) Get(ctx context.Context, _a1 log.Logger) ([]*model.Payment, error) {
